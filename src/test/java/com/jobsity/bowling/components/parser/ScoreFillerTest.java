...
class ScoreFillerTest {
  ...
  @Test
  void testFillFrameScore() {
    PlayerData data = initPlayerData();
    PlayerData result = scoreFiller.fillFrameScore(data);
    Assertions.assertNotNull(result);
    Integer[] scores =
        result.getFrames().stream().map(BowlingFrame::getScore).toArray(Integer[]::new);
  ...
  void testGetNextValidPinFalls() {
    BowlingFrame frame = BowlingFrame.builder()
        .pinfalls(List.of(arrangePinfallWithFallValue(null), arrangePinfallWithFallValue(""),
            arrangePinfallWithFallValue(" "), arrangePinfallWithFallValue("X")))
        .build();
