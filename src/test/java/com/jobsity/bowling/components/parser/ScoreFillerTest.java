...
class ScoreFillerTest {
    ...
    void testFillFrameScore() {
        ...
        Assertions.assertArrayEquals(
                new Integer[] {20, 39, 48, 66, 74, 84, 90, 120, 148, 167}, scores);
    }
    ...
    private static PlayerData initPlayerData() {
        ...
        frames.add(
                initFrame(
                        ...
                        true,
                        false,
                        new Pinfall[] {initPinfall("7", 7), initPinfall("/", 3)}));
        frames.add(
                initFrame(
                        3,
                        false,
        ...
        frames.add(
                initFrame(
                        ...
                        true,
                        false,
                        new Pinfall[] {initPinfall("8", 8), initPinfall("/", 2)}));
        frames.add(
                initFrame(
                        7,
                        false,
        ...
        frames.add(
                initFrame(
                        ...
                        true,
                        new Pinfall[] {
                            initPinfall("X", 10), initPinfall("8", 8), initPinfall("1", 1)
                        }));
    ...
    private static BowlingFrame initFrame(
        ...
        return BowlingFrame.builder()
                ...
                .spare(isSpare)
                .strike(isStrike)
                .pinfalls(Stream.of(pinfalls).collect(Collectors.toList()))
                .build();
    }
