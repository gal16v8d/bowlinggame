        ...
        return Stream.of(
                Arguments.of(
                        BowlingFrame.builder()
                                .bonus(true)
                                .pinfalls(List.of(arrangePinfall()))
                                .build()),
                Arguments.of(
                        BowlingFrame.builder()
                                .bonus(true)
    ...
    void testCheckIfValidOnLastFrameLaunchExc(int sumofAllFallPin, int bonusPin) {
        BadBowlingInputException bbie =
                Assertions.assertThrows(
                        ...
                        () ->
                                bowlingValidation.checkIfValidFrameOnLastFrame(
                                        sumofAllFallPin, bonusPin));
        Assertions.assertEquals(
                BowlingValidationImpl.VALID_FRAME_LAST_FRAME_MSG, bbie.getMessage());
    }
